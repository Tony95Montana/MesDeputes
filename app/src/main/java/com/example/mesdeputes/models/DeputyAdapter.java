...
public class DeputyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) convertView = LayoutInflater.from(context).inflate(R.layout.item_deputy, parent, false);
        TextView textViewName = convertView.findViewById(R.id.textViewItemDeputyName);
        textViewName.setText(deputies.get(position).getFirstname() + " " + deputies.get(position).getLastname());
